...
data class Deltaker(
    ...
    val erOpplaeringstiltak get(): Boolean = deltakerliste.tiltakstype.tiltakskode.erOpplaeringstiltak()

    val erFellesOppstart get(): Boolean = deltakerliste.erFellesOppstart

package no.nav.amt.deltaker.deltaker.deltakerendring
...
import no.nav.amt.deltaker.deltaker.DeltakerEndringUtfallHandler
...
class DeltakerEndringUtfallHandlerTest {
    ...
    fun `sjekkUtfall - endret start- og sluttdato i fortid, venter pa oppstart - deltaker blir har sluttet`(): Unit = runBlocking {
        ...
        val deltakerEndringUtfallHandler =
            DeltakerEndringUtfallHandler(deltaker, endringsrequest.toDeltakerEndringEndring(), deltakerHistorikkServiceMock)
        val resultat = deltakerEndringUtfallHandler.sjekkUtfall()

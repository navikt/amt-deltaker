...
import no.nav.amt.deltaker.api.model.AvsluttDeltakelseRequest
import no.nav.amt.deltaker.api.model.BakgrunnsinformasjonRequest
import no.nav.amt.deltaker.api.model.DeltakelsesmengdeRequest
import no.nav.amt.deltaker.api.model.FjernOppstartsdatoRequest
import no.nav.amt.deltaker.api.model.ForlengDeltakelseRequest
import no.nav.amt.deltaker.api.model.IkkeAktuellRequest
import no.nav.amt.deltaker.api.model.InnholdRequest
import no.nav.amt.deltaker.api.model.ReaktiverDeltakelseRequest
import no.nav.amt.deltaker.api.model.SluttarsakRequest
import no.nav.amt.deltaker.api.model.SluttdatoRequest
import no.nav.amt.deltaker.api.model.StartdatoRequest

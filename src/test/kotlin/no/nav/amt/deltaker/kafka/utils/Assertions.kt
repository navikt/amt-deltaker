...
fun assertProduced(deltakerId: UUID) {
    ...
    eventually {
        ...
        cachedDeltaker.shouldNotBeNull()
...
fun assertProducedForslag(forslag: Forslag) {
    ...
    eventually {
        assertSoftly(cache[forslag.id].shouldNotBeNull()) {
            ...
            opprettet shouldBeCloseTo forslag.opprettet
            opprettetAvArrangorAnsattId shouldBe forslag.opprettetAvArrangorAnsattId
            sammenlignForslagStatus(status, forslag.status)
        }
    }
